...
import sty from "./PlasmicProjectHeader.module.css"; // plasmic-import: Q4EyU15gIzBs/css
...
function PlasmicProjectHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.columns___2QxCr)}>
        <div className={classNames(projectcss.all, sty.column__eL8Xa)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column__clYaD)}>
          <div className={classNames(projectcss.all, sty.columns__xqg1K)}>
            <div className={classNames(projectcss.all, sty.column___6Fopw)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__e7Xs3)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.column__ozcoJ)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__zNjlj)}>
                {renderPlasmicSlot({
