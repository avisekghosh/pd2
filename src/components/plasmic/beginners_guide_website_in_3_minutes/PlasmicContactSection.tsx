...
import sty from "./PlasmicContactSection.module.css"; // plasmic-import: MrS3FLCM5X0h/css
...
function PlasmicContactSection__RenderFunc(props: {
  ...
  return (
    <Stack__
      ...
      id={"contact"}
    >
      <div className={classNames(projectcss.all, sty.freeBox__jez5M)}>
        <h2
        ...
        <div className={classNames(projectcss.all, sty.freeBox__tvIqb)}>
          <a
